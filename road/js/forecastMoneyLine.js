...
/*function showEcharts() {
    $("#forecast_moneyLine").css({"width":$("#forecast_moneyLine").width(),"height":$("#forecast_moneyLine").height()});
}
showEcharts()*/
var mpchat = echarts.init(document.getElementById('forecast_moneyLine'))
var option = {
    /*title: {
        text: '多种资金百分比'
    },*/
